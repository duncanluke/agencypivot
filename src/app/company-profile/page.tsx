      ...
      <div className="pt-32 pb-16 px-6 lg:px-12 max-w-7xl mx-auto space-y-32">
        ...
        <section className="space-y-12 print:break-before-page">
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-400 text-lg">
              The infrastructure driving measurable social return.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Stakeholder Management */}
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl flex flex-col md:flex-row gap-6">
              <div className="bg-orange-500/10 p-4 rounded-xl h-fit border border-orange-500/20">
              ...
              <div className="space-y-3">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Keeping track of application, implementation and reporting in
                  relation to funding while ensuring the correct supporting
                  documentation is updated, is part of what our solution covers
                  for you. All via an easy to use and supported Online portal.
                </p>
              </div>
            </div>
            ...
            {/* Impact Dashboard */}
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl flex flex-col md:flex-row gap-6">
              <div className="bg-blue-500/10 p-4 rounded-xl h-fit border border-blue-500/20">
              ...
              <div className="space-y-3">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  From day to day admin to oversight. Alignment to
                  Sustainability, Corporate Citizenship and Community is
                  critical for business in the 2020's. We help keep Exco's
                  informed on the spend for BEE, SED, ED, CSI and
                  Sustainability.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl flex flex-col md:flex-row gap-6">
              <div className="bg-cyan-500/10 p-4 rounded-xl h-fit border border-cyan-500/20">
              ...
              <div className="space-y-3">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  We provide a secure online portal, with data verification
                  controls in place. Keep your data safe with our solutions.
                  Your data can now be clearly comparable to tell your impact
                  story.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl flex flex-col md:flex-row gap-6">
              <div className="bg-green-500/10 p-4 rounded-xl h-fit border border-green-500/20">
              ...
              <div className="space-y-3">
                ...
                <p className="text-indigo-400 text-sm font-medium">
                  Projects Analysis and Recommendations
                </p>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Sustainability data, CSI projects and Programmes, our Data
                  collection process helps you make better decisions on your
