    ...
    <main className="min-h-screen bg-[#05080f] text-slate-200 overflow-x-hidden">
      ...
      <section className="py-20 px-6 relative bg-gradient-to-b from-[#05080f] to-[#080d1a] border-t border-indigo-900/20">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-sm font-bold uppercase tracking-wider mb-8">
            <CheckCircle2 className="w-4 h-4" /> The Future of Work
          </div>
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-tight">
            Don't just automate tasks. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Hire a Digital Employee.</span>
          </h2>
