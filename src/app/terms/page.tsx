    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-32 text-slate-300 min-h-screen">
            ...
            <div className="prose prose-invert prose-indigo max-w-none">
                ...
                <p>ai.collective.social provides generative AI blueprints, operational consulting, and custom software development services. We reserve the right to modify or discontinue the service at any time.</p>
                ...
                <p>Generated blueprints are provided for informational purposes only. ai.collective.social is not liable for any damages or losses related to your use of or reliance on our generated architectures.</p>
            </div>
        </div>
    );
}
